...
namespace MNIB_Distribution_Manager
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            im.PrintLarge((sender as FrameworkElement).DataContext as ExportDetail);
        }
        ...
        private void ComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (((ComboBoxItem)e.AddedItems[0]).Content.ToString() == "Sales Order")
            {
                ...
                ExportNumberTxt.Visibility = Visibility.Visible;
                ExportNumberTxt.Focus();
            }

            if (((ComboBoxItem)e.AddedItems[0]).Content.ToString() == "Non-Export")
            {
                //HavesterGrd.Visibility = Visibility.Visible;
                BarCodeGrd.Visibility = Visibility.Visible;
                ExportNumberTxt.Visibility = Visibility.Collapsed; 
            }
